...
MIN     EQU 32H    ; Define variable for minimum at address 32H
...
START:
    ...
    JNC LARGER        ; Jump if NUM1 is not less than NUM2
    
    MOV C, A          ; Move NUM2 to C (NUM2 is smaller)
    JMP CONTINUE      ; Jump to CONTINUE
    
LARGER:
    MOV C, B          ; Move NUM1 to C (NUM1 is smaller)
    
CONTINUE:
    MOV MIN, C        ; Store the minimum value in MIN
